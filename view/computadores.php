...
$sql = "SELECT p.*, MAX(i.Imagen) AS ImagenBinaria FROM productos p LEFT JOIN imagenes i ON p.ID = i.Producto_ID WHERE p.Disponibilidad != 0 AND p.Categoria = 'Computador' GROUP BY p.ID ORDER BY RAND()";
